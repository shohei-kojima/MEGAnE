...
parser.add_argument('-input_scaffold', help='Optional. Specify a scaffold VCF generated by the "-make_scaffold" option. This option is for joint calling of massive samples (e.g. >10,000).', action='store_true')
