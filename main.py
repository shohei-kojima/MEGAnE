...
parser.add_argument('-sample_name', metavar='str', type=int, help='Optional. Specify sample name which will be labeled in the VCF output. If not specified, BAM/CRAM filename will be output.')
