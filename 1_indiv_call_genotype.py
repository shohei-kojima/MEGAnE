...
parser.add_argument('-mk', metavar='str', type=str, help='Optional, but highly recommended. Specify .mk file generated by the step 0 "build_kmer_set". E.g., GRCh38DH.fa.mk. Please make sure that .mi file also exists in the same directory.')
